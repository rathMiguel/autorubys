...
$to = "rancid696jp@auto-rubys.com";
// $to = "rath.miguel@gmail.com";

//自動返信メールの送信元メールアドレス
//必ず実在するメールアドレスでかつ出来る限り設置先サイトのドメインと同じドメインのメールアドレスとすることを強く推奨します
$from = "rancid696jp@auto-rubys.com";
// $from = "rath.miguel@gmail.com";
...
$subject = "【ホームページより】スズスポグリルのお問い合わせ";
...
この度は、オートルビーズへスズスポグリルのお問い合わせをいただき、誠にありがとうございます。
下記の内容を受け付けました。
1営業日内に改めて確認メールをお送りします。
