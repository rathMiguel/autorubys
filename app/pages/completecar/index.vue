...
div
  ...
  .page-main
    .hero
      .hero-wrap
        .hero-maincar: img(src="~/assets/images/completecar/hero_car.png" alt="")
        .hero-content
    ...
    section.section
      header.section-header
        ...
        span.title.section-title--en Model Lineup
      .bg.bg-primary
        .container
          CompleteCarItems
    section.section
...
.hero{
  background-image: url('~/assets/images/completecar/hero.png');
