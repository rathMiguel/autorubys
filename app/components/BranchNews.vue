...
.topics-main
  //- pre {{ posts }}
  .media-loop
    template(v-for="(post, index) in posts.business_discovery.media.data", v-if="index < 4")
      ...
      .popup-wrap(v-on:click.self="popupClose")
        .popup-panel
          .popup-controls
            ...
            i.control-right(v-on:click="popupNumberIncrement" v-if="number < 3")
          .popup-panel__wrap
